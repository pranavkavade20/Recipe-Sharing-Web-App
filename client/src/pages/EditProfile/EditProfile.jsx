...
function EditProfile() {
  ...
  async function getProfileDetails() {
    try {
      const profileResponse = await fetch(`http://localhost:8000/user/edit/profile/`, {
        credentials: "include"
      })
    ...
    if (file) {
      ...
      reader.onload = async function (e) {
        ...
        try {
          ...
          const profilePictureResponse = await fetch("http://localhost:8000/user/edit/profile/", {
            method: "PATCH",
  ...
  async function updateUsername(e, newUsername) {
    ...
    try {
      const usernameResponse = await fetch("http://localhost:8000/user/edit/profile/", {
        method: "PATCH",
        body: JSON.stringify(data),
        headers: {
          "Content-Type": "application/json"
